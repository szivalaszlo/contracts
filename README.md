...
The following two articles may serve as further explanation.

{% embed url="https://www.baeldung.com/jpa-entities" %}

{% embed url="https://spring.io/guides/gs/accessing-data-jpa/\#initial" %}
